...
//+------------------------------------------------------------------+
//| REMOVED v5.6: Double Parcelling Orphan Functions                 |
//+------------------------------------------------------------------+
// Le seguenti funzioni sono state rimosse in v5.6:
// - ClosePositionPartial_AndTrack() - Mai chiamata dopo rimozione DP
